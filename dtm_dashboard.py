...
df = pd.read_excel("https://yajitersoo.github.io/jsonapi/hdx-_06a-dtm-nigeria-round-39-dataset-of-site-assessment.xlsx", sheet_name="Site Assessment Dataset")
...
#                            style = {'height':'48px', 'width':'26px'},
    ...
    dbc.CardBody(
        [
             ...
             html.Div(html.H5(["{:,}".format(int(np.sum(df['Number of Individuals'])))], className="card-title text-wrap", style={"text-align": "left", 
            ...
            className="card-text", style={"text-align": "left", 'font-family':'Calibri Light', 'font-size':'16px','color': 'black'})
        ]
    )
    ,className="col-md-10")
...
#                            style = {'height':'48px', 'width':'26px'},
    ...
    dbc.CardBody(
        [
            ...
            html.Div(html.H5(id="idps_cited_traupalin", className="card-title text-wrap", style={"text-align": "left", 
                                                                       'font-family':'Calibri Bold', 
                                                                       'font-size':'18px',
                                                                        'color': 'black',
                                                                        "font-weight":"bold",
...
#                            style = {'height':'48px', 'width':'26px'},
    ...
    dbc.CardBody(
        [
            ...
            html.Div(html.H5(id="idps_port_water", className="card-title text-wrap", style={"text-align": "left", 
                                                                       'font-family':'Calibri Bold', 
                                                                       'font-size':'18px',
                                                                        'color': 'black',
                                                                        "font-weight":"bold",
...
#                            style = {'height':'48px', 'width':'26px'},
    ...
    dbc.CardBody(
        [
            ...
            html.Div(html.H5(id="idps_blanket_needed_nfi", className="card-title text-wrap", style={"text-align": "left", 
                                                                       'font-family':'Calibri Bold', 
                                                                       'font-size':'18px',
                                                                        'color': 'black',
                                                                        "font-weight":"bold",
...
#                            style = {'height':'48px', 'width':'26px'},
    ...
    dbc.CardBody(
        [
            ...
            html.Div(html.H5(id="education_facility", className="card-title text-wrap", style={"text-align": "left", 
                                                                       'font-family':'Calibri Bold', 
                                                                       'font-size':'18px',
                                                                        'color': 'black',
                                                                        "font-weight":"bold",
...
#                            style = {'height':'48px', 'width':'26px'},
    ...
    dbc.CardBody(
        [
            ...
            html.Div(html.H5(id="idps_regular_med", className="card-title text-wrap", style={"text-align": "left", 
                                                                       'font-family':'Calibri Bold', 
                                                                       'font-size':'18px',
                                                                        'color': 'black',
                                                                        "font-weight":"bold",
...
def update_output(selected_state, selected_lga):
    ...
    # Percentage of men
    percentage_men = ((dff['Men (18 - 59 y)'].sum() + dff['(Elderly men 60+ y)'].sum())/dff['Number of Individuals'].sum())
    percentage_men = "{:.0%}".format(percentage_men)
    
    # Percentage of women
    percentage_women = ((dff['Women (18 - 59 y)'].sum() + dff['(Elderly women 60+ y)'].sum())/dff['Number of Individuals'].sum())
    ...
    percentage_port_water_not = (percentage_port_water_not.loc[percentage_port_water_not['Is drinking water potable'] == 'yes', 'Percent'].iloc[0])/100
    ...
    percentage_port_water_not = (percentage_port_water_not.loc[percentage_port_water_not['Is drinking water potable'] == 'no', 'Percent'].iloc[0])/100
    percentage_port_water_not
    percentage_port_water_not = "{:.0%}".format(percentage_port_water_not)
    percentage_port_water_not
